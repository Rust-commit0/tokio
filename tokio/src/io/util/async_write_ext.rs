...
cfg_io_util! {
    ...
    = " This method is cancellation safe in the sense that if it is used as"] #[doc =
    " the event in a [`tokio::select!`](crate::select) statement and some"] #[doc =
    " other branch completes first, then it is guaranteed that no data was"] #[doc =
    ...
    " If `write_all_buf` is used as the event in a"] #[doc =
    ...
    " # Cancel safety"] #[doc = ""] #[doc =
    " This method is not cancellation safe. If it is used as the event"] #[doc =
    " in a [`tokio::select!`](crate::select) statement and some other"] #[doc =
    " branch completes first, then the provided buffer may have been"] #[doc =
    ...
    " If `flush` is used as the event in a [`tokio::select!`](crate::select)"] #[doc =
    " statement and some other branch completes first, then the data in the"] #[doc =
    " buffered data in this `AsyncWrite` may have been partially flushed."] #[doc =
