...
pin_project! {
    ...
    inner : Option < TimerShared >, deadline : Instant, registered : bool, } impl
    PinnedDrop for TimerEntry { fn drop(this : Pin <& mut Self >) { this.cancel(); } }
}
...
pub(super) type EntryList = crate::util::linked_list::LinkedList<
    TimerShared,
    TimerShared,
>;
